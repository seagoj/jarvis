...
--
-- Host: mysql50-28.wc1:3306
-- Generation Time: Apr 05, 2012 at 10:47 PM
...
--
-- Database: `464119_jarvis`
--
CREATE DATABASE `464119_jarvis` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `464119_jarvis`;
...
CREATE TABLE IF NOT EXISTS `music` (
  ...
  `artist` varchar(50) NOT NULL COMMENT 'artist name',
  `album` varchar(100) NOT NULL COMMENT 'album title',
  `format` varchar(10) NOT NULL COMMENT 'format of playback',
  PRIMARY KEY  (`id`),
  KEY `id` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Table that stores information about my music collection' AUTO_INCREMENT=1 ;
--
...
(NULL, '464119_jarvis', 'music', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', 'row id'),
(NULL, '464119_jarvis', 'music', 'artist', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', 'artist name'),
(NULL, '464119_jarvis', 'music', 'album', 3, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', 'album title'),
(NULL, '464119_jarvis', 'music', 'format', 4, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', 'format of playback');
...
(NULL, '464119_jarvis', 'PRIMARY', NULL, '464119_jarvis', 'music', 'id', 1, NULL, NULL, NULL, NULL);
...
(85804854, '464119_jarvis', '172.17.10.61:60103', '464119_jarvis', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`', 12.415);
...
(NULL, '464119_jarvis', 'latin1', 'latin1_swedish_ci', NULL);
...
('''464119_jarvis''@''%''', NULL, '464119_jarvis', 'SELECT', 'NO'),
('''464119_jarvis''@''%''', NULL, '464119_jarvis', 'INSERT', 'NO'),
('''464119_jarvis''@''%''', NULL, '464119_jarvis', 'UPDATE', 'NO'),
('''464119_jarvis''@''%''', NULL, '464119_jarvis', 'DELETE', 'NO'),
('''464119_jarvis''@''%''', NULL, '464119_jarvis', 'CREATE', 'NO'),
('''464119_jarvis''@''%''', NULL, '464119_jarvis', 'DROP', 'NO'),
('''464119_jarvis''@''%''', NULL, '464119_jarvis', 'REFERENCES', 'NO'),
('''464119_jarvis''@''%''', NULL, '464119_jarvis', 'INDEX', 'NO'),
('''464119_jarvis''@''%''', NULL, '464119_jarvis', 'ALTER', 'NO'),
('''464119_jarvis''@''%''', NULL, '464119_jarvis', 'CREATE TEMPORARY TABLES', 'NO'),
('''464119_jarvis''@''%''', NULL, '464119_jarvis', 'LOCK TABLES', 'NO'),
('''464119_jarvis''@''%''', NULL, '464119_jarvis', 'EXECUTE', 'NO'),
('''464119_jarvis''@''%''', NULL, '464119_jarvis', 'CREATE VIEW', 'NO'),
('''464119_jarvis''@''%''', NULL, '464119_jarvis', 'SHOW VIEW', 'NO'),
('''464119_jarvis''@''%''', NULL, '464119_jarvis', 'CREATE ROUTINE', 'NO'),
('''464119_jarvis''@''%''', NULL, '464119_jarvis', 'ALTER ROUTINE', 'NO');
...
(NULL, '464119_jarvis', 'music', 0, '464119_jarvis', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, '464119_jarvis', 'music', 1, '464119_jarvis', 'id', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '');
...
(NULL, 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 576, 0, 672237504, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1183288', ''),
(NULL, 'information_schema', 'CLIENT_STATISTICS', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 210, 0, 662641770, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3245592', ''),
(NULL, 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 423, 0, 679966578, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1611286', ''),
(NULL, 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 387, 0, 672880770, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1761174', ''),
(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-06 03:47:19', '2012-04-06 03:47:19', NULL, 'utf8_general_ci', NULL, 'max_rows=177032', ''),
(NULL, 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 2565, 0, 680776650, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=265721', ''),
(NULL, 'information_schema', 'INNODB_BUFFER_POOL_CONTENT', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 845, 0, 679162835, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=806596', ''),
(NULL, 'information_schema', 'INDEX_STATISTICS', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 588, 0, 676969104, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1159140', ''),
(NULL, 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 4637, 0, 681133567, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=146986', ''),
(NULL, 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-06 03:47:19', '2012-04-06 03:47:19', NULL, 'utf8_general_ci', NULL, 'max_rows=950591', ''),
(NULL, 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 356, 0, 674001272, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1914534', ''),
(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-06 03:47:19', '2012-04-06 03:47:19', NULL, 'utf8_general_ci', NULL, 'max_rows=186324', ''),
(NULL, 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 3656, 0, 680085464, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=186426', ''),
(NULL, 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 2179, 0, 680013604, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=312792', ''),
(NULL, 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 2679, 0, 681317922, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=254413', ''),
(NULL, 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 3641, 0, 680266235, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=187194', ''),
(NULL, 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 2504, 0, 679402808, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=272194', ''),
(NULL, 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 2372, 0, 680424804, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=287341', ''),
(NULL, 'information_schema', 'TABLE_STATISTICS', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 411, 0, 673382400, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1658331', ''),
(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-06 03:47:19', '2012-04-06 03:47:19', NULL, 'utf8_general_ci', NULL, 'max_rows=155433', ''),
(NULL, 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 1986, 0, 679519830, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=343189', ''),
(NULL, 'information_schema', 'USER_STATISTICS', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 210, 0, 662641770, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3245592', ''),
(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-06 03:47:19', '2012-04-06 03:47:19', NULL, 'utf8_general_ci', NULL, 'max_rows=306187', ''),
(NULL, 'information_schema', 'INNODB_IO_PATTERN', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 235, 0, 667374855, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2900316', ''),
(NULL, 'information_schema', 'INNODB_RSEG', 'SYSTEM VIEW', 'MEMORY', 0, 'Fixed', NULL, 41, 0, 582178106, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=16623765', ''),
(NULL, '464119_jarvis', 'music', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 0, 1, '2012-04-01 16:00:06', NULL, NULL, 'latin1_swedish_ci', NULL, '', 'Table that stores information about my music collection; InnoDB free: 0 kB');
...
(NULL, '464119_jarvis', 'PRIMARY', '464119_jarvis', 'music', 'PRIMARY KEY');
